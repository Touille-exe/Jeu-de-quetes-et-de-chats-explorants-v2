...
class Jeuettoutenfaite:
    def __init__(self):
        ...
        self.map_layer = pyscroll.orthographic.BufferedRenderer(self.map_data, (self.taille_x, self.taille_y),
                                                                clamp_camera=True)
        ...
        ecran_charge()  # actualiser l'écran de chargement
...
class Image:
    def __init__(self):
        ...
        self.rect_boutton_parametre = self.boutton_parametre_img.get_rect(
            center=(self.taille_x / 4, self.TAILLE_Y_MOITIE))
        ...
        self.rect_boutton_retour = self.boutton_retour_img.get_rect(
            bottomright=(self.taille_x - 50, self.taille_y - 50))
...
def ecran_charge(self):
    texte2 = self.fontducharger.render("Note : Redemarer le jeu pour que les paramètres soits pris en compte", True,
                                       (197, 15, 31))
